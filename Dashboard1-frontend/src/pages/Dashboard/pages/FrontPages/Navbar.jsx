          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <div className="relative">
              <button 
                ...
                className={`px-3 py-2 rounded-md text-sm font-medium flex items-center ${dropdownOpen ? 'text-purple-600 bg-purple-50' : 'text-gray-600 hover:text-purple-600 hover:bg-purple-50'}`}
              >
                Pages
                <ChevronDown className={`ml-1 h-4 w-4 transition-transform ${dropdownOpen ? 'transform rotate-180' : ''}`} />
              </button>
