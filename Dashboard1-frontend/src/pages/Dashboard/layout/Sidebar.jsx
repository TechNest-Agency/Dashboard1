...
const Sidebar = ({ activeItem, setActiveItem, isSidebarOpen, setIsSidebarOpen }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`w-64 bg-white shadow-lg border-r border-gray-200 flex flex-col fixed top-0 left-0 z-50 transition-transform duration-300 sm:sticky sm:translate-x-0 h-screen sm:h-screen ${
          ...
          <div className="px-4">
            ...
            <div className="space-y-1 mt-2">
              <div
                ...
                aria-expanded={isWizardExamplesOpen}
              >
            ...
            <div className="space-y-1 mt-2">
              <div
                ...
                aria-expanded={isRolesPermissionsOpen}
              >
